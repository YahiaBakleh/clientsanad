...
class _MainScreenState extends State<MainScreen> {
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: Colors.white,
                borderRadius: BorderRadius.only(topLeft: Radius.circular(16.0), topRight: Radius.circular(16.0)), //end here
                boxShadow: [
                  BoxShadow(
                    color: Colors.black,
                    blurRadius: 16.0,
                  ...
                  children: [
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          children: [
                            Image.asset("images/pickicon.png", height: 70, width: 80.0),
                            SizedBox(
                              width: 16.0,
                            ),
                            Column(
                              ...
                              children: [
                                ...
                                Text(
                                  "The Spa destance from Session location",
                                  style: TextStyle(fontSize: 16.0, color: Colors.grey, fontFamily: "Brand Bold"),
                                ),
                              ],
                            )
                          ],
  ...
  Future<void> getPlaceDirection() async {
    ...
    var details = await AssistantMethod.obtainPlaceDirectionDetails(initialLatLng /*pickUpLatLng*/, sessionLatLng /*dropOffLatLng*/);
    ...
    if (initialLatLng.latitude > sessionLatLng.latitude && initialLatLng.longitude > sessionLatLng.longitude) {
      latLngBounds = LatLngBounds(southwest: initialLatLng, northeast: sessionLatLng);
    } else if (initialLatLng.longitude > sessionLatLng.longitude) {
      latLngBounds = LatLngBounds(southwest: LatLng(initialLatLng.latitude, sessionLatLng.longitude), northeast: LatLng(sessionLatLng.latitude, initialLatLng.longitude));
    } else if (initialLatLng.latitude > sessionLatLng.latitude) {
      latLngBounds = LatLngBounds(southwest: LatLng(sessionLatLng.latitude, initialLatLng.longitude), northeast: LatLng(initialLatLng.latitude, sessionLatLng.longitude));
    } else {
      latLngBounds = LatLngBounds(southwest: initialLatLng, northeast: sessionLatLng);
    }
    ...
    Marker sessionLocMarker = Marker(
      ...
      infoWindow: InfoWindow(title: sessionPos.placeName, snippet: "DropOff Location"),
